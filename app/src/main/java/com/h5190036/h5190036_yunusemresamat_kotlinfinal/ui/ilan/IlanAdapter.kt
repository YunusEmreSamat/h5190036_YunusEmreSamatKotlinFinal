...
import com.h5190036.h5190036_yunusemresamat_kotlinfinal.databinding.CardviewIlanBinding
...
class IlanAdapter(
        ...
        var onItemClickListener: ItemClickListener ) : RecyclerView.Adapter<IlanAdapter.ViewHolder>() {

    inner class ViewHolder(val binding: CardviewIlanBinding) : RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = CardviewIlanBinding.inflate(LayoutInflater.from(parent.context), parent, false)
